...
public interface Bills extends CdsData {
  String ID = "ID";
  ...
  static Bills create() {
    return Struct.create(Bills.class);
  }

  static Bills of(Map<String, Object> map) {
    return Struct.access(map).as(Bills.class);
  }

  static Bills create(String id) {
    Map<String, Object> keys = new HashMap<>();
    keys.put(ID, id);
    return Struct.access(keys).as(Bills.class);
  }
}
