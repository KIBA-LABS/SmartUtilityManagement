...
@CdsName("UtilityService.Payments")
@Generated("cds-maven-plugin")
public interface Payments extends CdsData {
  String ID = "ID";
  ...
  static Payments create() {
    return Struct.create(Payments.class);
  }

  static Payments of(Map<String, Object> map) {
    return Struct.access(map).as(Payments.class);
  }

  static Payments create(String id) {
    Map<String, Object> keys = new HashMap<>();
    keys.put(ID, id);
    return Struct.access(keys).as(Payments.class);
  }
}
