...
public interface ComplaintEntity extends CdsData {
  String ID = "ID";
  ...
  ComplaintEntity_ ref();

  static ComplaintEntity create() {
    return Struct.create(ComplaintEntity.class);
  }

  static ComplaintEntity of(Map<String, Object> map) {
    return Struct.access(map).as(ComplaintEntity.class);
  }

  static ComplaintEntity create(String id) {
    Map<String, Object> keys = new HashMap<>();
    keys.put(ID, id);
    return Struct.access(keys).as(ComplaintEntity.class);
  }
}
