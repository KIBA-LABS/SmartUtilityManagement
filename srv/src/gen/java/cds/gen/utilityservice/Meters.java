...
@CdsName("UtilityService.Meters")
@Generated("cds-maven-plugin")
public interface Meters extends CdsData {
  String ID = "ID";
  ...
  static Meters create() {
    return Struct.create(Meters.class);
  }

  static Meters of(Map<String, Object> map) {
    return Struct.access(map).as(Meters.class);
  }

  static Meters create(String id) {
    Map<String, Object> keys = new HashMap<>();
    keys.put(ID, id);
    return Struct.access(keys).as(Meters.class);
  }
}
